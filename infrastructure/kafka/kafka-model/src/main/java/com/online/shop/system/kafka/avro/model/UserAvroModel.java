...
public class UserAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2603450333340321274L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserAvroModel\",\"namespace\":\"com.online.shop.system.kafka.avro.model\",\"fields\":[{\"name\":\"userID\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}}]}");
   ...
   */
  public UserAvroModel(java.lang.String userID) {
    this.userID = userID;
  }
   ...
   */
  public static com.online.shop.system.kafka.avro.model.UserAvroModel.Builder newBuilder() {
    return new com.online.shop.system.kafka.avro.model.UserAvroModel.Builder();
  }
   ...
   * @return A new UserAvroModel RecordBuilder
   */
  public static com.online.shop.system.kafka.avro.model.UserAvroModel.Builder newBuilder(com.online.shop.system.kafka.avro.model.UserAvroModel.Builder other) {
    if (other == null) {
      return new com.online.shop.system.kafka.avro.model.UserAvroModel.Builder();
    } else {
      return new com.online.shop.system.kafka.avro.model.UserAvroModel.Builder(other);
    }
  }
   ...
   * @return A new UserAvroModel RecordBuilder
   */
  public static com.online.shop.system.kafka.avro.model.UserAvroModel.Builder newBuilder(com.online.shop.system.kafka.avro.model.UserAvroModel other) {
    if (other == null) {
      return new com.online.shop.system.kafka.avro.model.UserAvroModel.Builder();
    } else {
      return new com.online.shop.system.kafka.avro.model.UserAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.online.shop.system.kafka.avro.model.UserAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.online.shop.system.kafka.avro.model.UserAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userID)) {
        this.userID = data().deepCopy(fields()[0].schema(), other.userID);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.shop.system.kafka.avro.model.UserAvroModel.Builder setUserID(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.shop.system.kafka.avro.model.UserAvroModel.Builder clearUserID() {
      userID = null;
